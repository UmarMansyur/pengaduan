                  ...
                  <form>
                    <div class="row">
                      <div class="col-md-6 mb-3">
                        <label for="nama_lengkap" class="form-label fw-bold"><sup class="text-danger">*</sup>Nama Lengkap:</label>
                        <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" placeholder="Ketik nama lengkap anda" required>
                      </div>
                      <div class="col-md-6 mb-3">
                        <label for="username" class="form-label fw-bold"><sup class="text-danger">*</sup>NIK:</label>
                        <input type="text" class="form-control" id="username" name="username" placeholder="Ketik username anda" required>
                      </div>

                      <div class="col-md-4 mb-3">
                        <label for="username" class="form-label fw-bold"><sup class="text-danger">*</sup>Nomor HP:</label>
                        <input type="text" class="form-control" id="username" name="username" placeholder="Ketik username anda" required>
                      </div>
                      <div class="col-md-4 mb-3">
                        <label for="username" class="form-label fw-bold"><sup class="text-danger">*</sup>Usia:</label>
                        <input type="text" class="form-control" id="username" name="username" placeholder="Ketik username anda" required>
                      </div>
                      <div class="col-md-4 mb-3">
                        <label for="username" class="form-label fw-bold"><sup class="text-danger">*</sup>Jenis Kelamin:</label>
                        <input type="text" class="form-control" id="username" name="username" placeholder="Ketik username anda" required>
                      </div>
                      <div class="col-md-6 mb-3">
                      ...
                      <div class="col-md-6 mb-3">
                        <label for="username" class="form-label fw-bold"><sup class="text-danger">*</sup>Username:</label>
                        <input type="text" class="form-control" id="username" name="username" placeholder="Ketik username anda" required>
                      </div>
                      <div class="col-md-6 mb-3">
                        <label for="password" class="form-label fw-bold"><sup class="text-danger">*</sup>Password:</label>
                        <input type="password" class="form-control" id="password" name="password" placeholder="Ketik password anda" required>
                      </div>
                      <div class="col-md-6 mb-3">
                        <label for="password" class="form-label fw-bold"><sup class="text-danger">*</sup>Konfirmasi Password:</label>
                        <input type="password" class="form-control" id="password" name="password" placeholder="Ketik password anda" required>
                      </div>
                      <!-- alamt -->
                      ...
                      <div class="col-md-12 mb-3">
                        ...
                        <span class="d-block text-center mt-3">Sudah punya akun? <a href="/login.php" class="text-decoration-none fw-bold text-brand">Login</a></span>
                      </div>
                    </div>
                  </form>
                </div>
